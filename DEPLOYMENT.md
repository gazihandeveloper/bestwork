...
- DB: PostgreSQL bestwork; otomatik yedek /usr/local/bin/bestwork-pgdump.sh (gunluk 2x, 14 gun); sirlar /etc/bestwork/api.env (600)
- CI: .github/workflows/ci.yml (eskiz; GitHub Actions aktif edilince calisir)
