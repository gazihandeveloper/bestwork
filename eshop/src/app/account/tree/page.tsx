...
function TreeExplorer({
  ...
  return (
    <>
      ...
      {/* Dönem + arama (tek satırda) */}
      <div className="flex flex-wrap items-center gap-2">
        <label
          title={tree.minMonth ? `En eski kayıt: ${tree.minMonth}` : undefined}
          className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-gray-300 bg-white px-3 py-2.5"
        >
