        ...
        <div className="lg:col-span-8 xl:col-span-9">
          ...
          {actualLevelIndex < 5 && (
            <button
              ...
              className="mb-3 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#29a56c] py-3.5 text-lg font-extrabold text-white shadow-lg ring-2 ring-[#29a56c]/40 transition-transform duration-200 hover:-translate-y-0.5 hover:brightness-110"
            >
              Üyelik seviyenizi yükseltmek için burayı tıklayınız!
            </button>
          )}
          ...
          <Link
            ...
            className="mt-3 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#29a56c] py-3.5 text-lg font-extrabold text-white shadow-lg ring-2 ring-[#29a56c]/40 transition-transform duration-200 hover:-translate-y-0.5 hover:brightness-110"
          >
            Ekip Takip Raporları
          </Link>
        </div>
      </div>
