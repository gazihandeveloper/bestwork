      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="truncate text-[10px] fw-700 text-gray-500" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>{rec.member_code || '—'}</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          <span className="inline-flex min-w-0 flex-1 items-center justify-center gap-1 rounded-md bg-sky-100 px-1 py-0.5 text-[8px] fw-700 tracking-wide text-sky-700">
            SOL CV
            <span className="truncate text-[10px] fw-700 tabular-nums text-sky-900" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
          ...
          <span className="inline-flex min-w-0 flex-1 items-center justify-center gap-1 rounded-md bg-violet-100 px-1 py-0.5 text-[8px] fw-700 tracking-wide text-violet-700">
            SAĞ CV
            <span className="truncate text-[10px] fw-700 tabular-nums text-violet-900" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
        ...
        <button
          ...
          className={`absolute -top-2 right-2 z-[2] flex h-5 w-5 cursor-pointer items-center justify-center rounded-full shadow-sm transition-colors ${
            pinned ? 'bg-red-500 text-white ring-2 ring-red-200' : 'bg-gray-300 text-gray-600 hover:bg-gray-400'
          }`}
        >
