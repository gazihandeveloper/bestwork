...
/** FacebookIcon — marka işareti (Lucide marka ikonu içermez) */
export function FacebookIcon({ size = 24, className, title, ...rest }: BrandIconProps) {
  return (
    <svg
...
/** TwitterIcon — marka işareti (Lucide marka ikonu içermez) */
export function TwitterIcon({ size = 24, className, title, ...rest }: BrandIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
